  ...
  return (
    <div className="mx-auto max-w-[300px]">
      ...
      <motion.div
        ...
        className="mt-4 max-w-[264px] font-mono text-2xs tracking-widest text-gray-400"
      >
        <p></p>
      ...
      <div className="mt-6">
        ...
        <p className="mt-4 font-body text-2xs text-gray-200">
          I usually come up with ideas, or if you have an idea, I'll definitely
          try to work with you. A lot of it is just freestyling and mostly
          coming up with things on the spot. I never left a shoot without at
          least some photos that I didn't like so far.
        </p>
      </div>
      <div className="mt-6">
        <p className="font-serif text-xs text-gray-300">
